    ...
    <div className={cn("flex flex-col gap-1 w-full", className)}>
      {label && (
        <label
          className={cn(
            ...
            focus ? "text-white/90" : "text-white/50",
          )}
        >
          {label}
        </label>
      ...
      <div className="relative w-full">
        <input
          ...
          onBlur={onBlur}
          className={cn(
            "w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-white/30 outline-none transition",
